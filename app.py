...
COLORES_ESTADOS = {
    "San Luis Potosí": "#E63946",  # Rojo/Carmesí Héroe
...
CARD_BG     = "#FFFFFF"
TEXT_PRIM   = "#2C3E50"  # Texto Azul/Gris oscuro
TEXT_SEC    = "#6B6B6B"
...
# 3. NUEVA FUNCIÓN PARA SCATTER CON OLS
...
app.layout=html.Div(
    ...
    dcc.Tabs(id="main-tabs",value="tab-visor",
        ...
        dcc.Tab(label="📊 Visor de Datos", value="tab-visor",
            ...
            # 3. NUEVO SCATTER OLS (Líneas de tendencia)
            html.Div(style=CARD,children=[
                html.P("Dispersión y Tendencia (OLS)",style=SEC_HDR),
                html.P("Muestra la relación lineal (Betas) entre las variables elegidas en el Eje X e Y. Pasa el cursor sobre la línea para ver el R².",style=SUB),
...
def update_eco(estados,_,yr_from,yr_to,vars_x):
    ...
    # Tabla coefs
    nombres={"Empleo_Manufacturero":"Empleo Manufacturero","IED":"Inv. Extranjera Directa (IED)","ActInd":"Actividad Manufacturera","Exportaciones":"Exportaciones Manufactureras"}
...
def update_tabla(estados,yr_from,yr_to):
    ...
    ths=["Estado","Año","Trim.","Empleo Mfr.","IED (M USD)","Act. Mfr.","Exp. Mfr.(M USD)","Var.Emp %"]
